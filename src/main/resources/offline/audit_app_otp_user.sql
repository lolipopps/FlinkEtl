...
INSERT OVERWRITE TABLE ods.audit_app_otp_user partition(stat_hour='2020070701')
SELECT  logcontent 
       ,userid 
       ,domainid 
       ,hostname 
...
WHERE date_format(substr(regexp_replace(center_time,"T"," "),1,19),"yyyyMMddHH") = '2020070701'; 

DROP TABLE IF EXISTS dw.audit_app_otp_user_2020070701; -- 数据加工
CREATE TABLE dw.audit_app_otp_user_2020070701 AS
