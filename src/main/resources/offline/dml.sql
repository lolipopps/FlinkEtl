 ...
 CREATE EXTERNAL TABLE IF NOT EXISTS stg.system_safe_operation_auth
...
TBLPROPERTIES(
'es.resource'='system-safe-operation_auth-${hiveconf:stat_date}/doc',
'es.nodes'='kafka:9810'
);

CREATE EXTERNAL TABLE IF NOT EXISTS stg.system_safe_attack_ips ( 
...
STORED BY 'org.elasticsearch.hadoop.hive.EsStorageHandler' 
TBLPROPERTIES( 
  'es.resource'='system-safe-attack_ips*/doc'
, 'es.nodes'='kafka:9810' );
...
STORED BY 'org.elasticsearch.hadoop.hive.EsStorageHandler' 
TBLPROPERTIES( 
  'es.resource'='audit-linuxserver-process-${hiveconf:stat_date}/doc'
, 'es.nodes'='kafka:9810' );

CREATE EXTERNAL TABLE IF NOT EXISTS stg.audit_app_otp_user ( 
logcontent string 
,userid string 
,domainid string 
,hostname string 
...
STORED BY 'org.elasticsearch.hadoop.hive.EsStorageHandler' 
TBLPROPERTIES( 
'es.resource'='audit-app-otp_user-${hiveconf:stat_date}/doc'
, 'es.nodes'='kafka:9810' 
); -- 登入行为
...
,limit_use bigint )
STORED BY 'org.elasticsearch.hadoop.hive.EsStorageHandler' 
TBLPROPERTIES( 'es.resource'='audit-linuxserver-abnormalprogress-${hiveconf:stat_date}/doc'
, 'es.nodes'='kafka:9810' );
...
STORED BY 'org.elasticsearch.hadoop.hive.EsStorageHandler' 
TBLPROPERTIES( 
'es.resource'='audit-linuxserver-address-${hiveconf:stat_date}/doc'
, 'es.nodes'='kafka:9810' 
);
CREATE EXTERNAL TABLE IF NOT EXISTS stg.audit_linuxserver_file ( 
event_sender string 
,event_source_id string 
...
STORED BY 'org.elasticsearch.hadoop.hive.EsStorageHandler' 
TBLPROPERTIES( 
'es.resource'='audit-linuxserver-file-${hiveconf:stat_date}/doc'
, 'es.nodes'='kafka:9810' );
...
,event_time timestamp ) 
STORED BY 'org.elasticsearch.hadoop.hive.EsStorageHandler' 
TBLPROPERTIES( 'es.resource'='audit-linuxserver-network-${hiveconf:stat_date}/doc', 'es.nodes'='kafka:9810' );
