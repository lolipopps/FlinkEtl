...
INSERT OVERWRITE TABLE ods.system_safe_attack_ips partition(stat_hour='${hiveconf:stat_hour}')
...
DROP TABLE IF EXISTS dw.system_safe_attack_ips_${hiveconf:stat_hour};
CREATE TABLE dw.system_safe_attack_ips_${hiveconf:stat_hour} AS
