...
INSERT OVERWRITE TABLE ods.audit_linuxserver_file partition(stat_hour='${hiveconf:stat_hour}')
SELECT  event_sender 
       ,event_source_id 
       ,operation_type 
       ,module_type 
...
DROP TABLE IF EXISTS dw.audit_linuxserver_file_${hiveconf:stat_hour}; -- 数据加工
CREATE TABLE dw.audit_linuxserver_file_${hiveconf:stat_hour} AS
