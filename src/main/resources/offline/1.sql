SELECT  user_id 
       ...
       ,AVG(unix_timestamp(substr(regexp_replace(center_time,"T"," "),1,19)) - unix_timestamp(cast(event_time  AS string))) AS avgDruid
FROM default.system_safe_operation_auth_2020_06_17
GROUP BY  user_id 
         ,login_ip 
         ,facility_ip; 