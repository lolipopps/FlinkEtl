...
INSERT OVERWRITE TABLE ods.audit_linuxserver_address partition(stat_hour='2020062411')
SELECT  event_sender 
       ,event_source_id 
       ,module_type 
       ,user_name 
...
WHERE date_format(substr(regexp_replace(center_time,"T"," "),1,19),"yyyyMMddHH") = '2020062411'; 

DROP TABLE IF EXISTS dw.audit_linuxserver_address_2020062411; -- 数据加工
CREATE TABLE dw.audit_linuxserver_address_2020062411 AS
