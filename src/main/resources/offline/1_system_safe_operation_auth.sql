...
WHERE date_format(substr(regexp_replace(center_time,"T"," "),1,19),"yyyyMMddHH") = '2020061701'; 

DROP TABLE IF EXISTS dw.system_safe_operation_auth_2020061701;
CREATE TABLE dw.system_safe_operation_auth_2020061701 AS
SELECT  user_id 
       ,login_ip 
       ,facility_ip 
