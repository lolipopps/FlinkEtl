...
public final class MyKafka011SourceStreamOp extends BaseKafkaSourceStreamOp<MyKafka011SourceStreamOp>
        implements Kafka011SourceParams<MyKafka011SourceStreamOp> {

    public MyKafka011SourceStreamOp() {
        this(new Params());
    }

    public MyKafka011SourceStreamOp(Params params) {
        super(AnnotationUtils.annotatedName(MyKafka011SourceStreamOp.class), params);
    }
    ...
    protected Table initializeDataSource() {
        ...
        StartupMode startupMode = getParams().get(KafkaSourceParams.STARTUP_MODE);
