...
public class KafkaSinkTemplate {
    ...
    public void sinkToKafkaSerializationSchema() throws Exception {
        ...
        FlinkKafkaProducer011<Tuple2<Integer, String>> flinkKafkaProducer = new FlinkKafkaProducer011(
                "intsmaze-discover-1",
    ...
    public void sinkToKafkaPartiton() throws Exception {
        ...
        FlinkKafkaProducer011<Tuple2<Integer, String>> producerPartition = new FlinkKafkaProducer011(
                "intsmaze-discover-1",
